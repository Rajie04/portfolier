	...
	return (
		...
		>
			...
			<div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
				<div className="flex flex-col xl:flex-row gap-6">
					...
					<div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-center items-end text-right xl:-ml-16 z-10">
						<p className="font-titleFont text-textGreen text-lg tracking-wide">
							Hacklahoma
						</p>
						<h3 className="text-2xl font-bold">Executive Director</h3>
						<p className="bg-[#112240] text-lg md:text-base p-2 md:p-6 rounded-md">
							Orchestrating and overseeing all logistical elements, resulting in
							a successful hackathon with over 200 participants. Directing a
							team of 20 members, and coordinate communication between 4 teams
							to ensure project execution.
						</p>
						<div className="flex flex-row items-center gap-4 text-lg">
							Check out some of the projects from this year!
							<a
								href="https://hacklahoma-2024.devpost.com/"
								className="hover:text-textGreen hover:-translate-y-1 transform duration-300"
								target="_blank"
							>
								<RxOpenInNewWindow />
							</a>
			...
			<div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
				<div className="flex flex-col xl:flex-row-reverse gap-6">
					<a
						href="https://muslimsofou.wixsite.com/oumsa"
						className="w-full xl:w-1/2 h-auto relative group"
						target="_blank"
					>
						<div>
					...
					<div className="w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-center items-end text-right xl:-ml-16 z-10">
						...
						<p className="bg-[#112240] text-lg md:text-base p-2 md:p-6 rounded-md">
							Managed MSA's social media platforms, creating engaging content,
							and fostering online engagement to increase our reach and impact.
						</p>
						<div className="flex flex-row items-center gap-4 text-lg">
