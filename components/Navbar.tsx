...
const Navbar = () => {
	...
	const handleClick = (e: any) => {
		if (e.target.contains(refer.current)) {
			setShowMenu(false);
		}
	};
				...
				<div className="hidden mdl:inline-flex items-center gap-7">
					<ul className="flex text-[18px] gap-7">
						...
						>
							...
							>
								<span className="text-textGreen"></span>[ experience ]
							</motion.li>
						</Link>
						<Link
							onClick={handleScroll}
						...
						>
							...
							>
								<span className="text-textGreen"></span>[ activities ]
							</motion.li>
						</Link>
						<Link
							onClick={handleScroll}
					...
					>
						...
						>
							...
							<div className="flex flex-col items-center gap-7 mt-12">
								...
								<a href="/assets/Ahmed_Resume2.pdf" target="_blank">
									<motion.button
										initial={{ opacity: 0 }}
										animate={{ opacity: 1 }}
										transition={{ delay: 0.5 }}
								...
								<div className="flex gap-4 mt-8">
									...
									<a
										href="https://www.linkedin.com/in/rtahmed/"
										target="_blank"
									>
										<span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
											<SlSocialLinkedin />
