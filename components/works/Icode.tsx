	...
	return (
		...
		>
			<h3 className="flex flex-wrap gap-1 font-semibold text-[22px] lg:text-jobTitle font-titleFont tracking-wide">
				...
				<span className="text-textGreen tracking-wide">@iCode</span>
			</h3>
			...
			<ul className="mt-6 flex flex-col gap-3">
				<li className="text-jobDuration flex gap-2 text-textDark">
					...
					Built strong foundations in Java and JavaScript for 15-student
					classes, resulting in a 30% improvement in assessment scores.
				</li>
				<li className="text-jobDuration flex gap-2 text-textDark">
					<span className="text-textGreen mt-1">
						<FaAngleRight />
					</span>
					Asessed student progress through regular evaluations and provided
