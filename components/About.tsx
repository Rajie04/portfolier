		...
		>
			...
			<div className="flex flex-col lgl:flex-row gap-12 lgl:gap-32">
				<div className="w-full lgl:w-2/3 text-[18px] md:text-pg text-textDark font-medium flex flex-col gap-6">
					<p>
						I'm currently a SWE intern at ConocoPhillips. I'm also the Executive
						Director of Hacklahoma, Oklahoma's largest hackathon!
					</p>
					...
					<p>
						Outside of work and studies, I enjoy playing and watching
						basketball, watching anime, and going to new coffee shops!{" "}
						{"(*^o^*)"}
					</p>
				</div>
